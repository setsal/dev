...
PROGS       = afl-gcc afl-fuzz aflnet-replay afl-showmap afl-tmin afl-gotcpu afl-analyze aflnet-fuzz aflnet-showmap aflnet-showmap-nwe aflnet-replay-nwe aflnet-replay-simple
...
afl-fuzz2: afl-fuzz2.c $(COMM_HDR) aflnet.o aflnet.h | test_x86
	$(CC) $(CFLAGS) $@.c aflnet.o -o $@ $(LDFLAGS)
...
aflnet-replay-nwe: aflnet-replay-nwe.c $(COMM_HDR) aflnet.o aflnet.h | test_x86
	$(CC) $(CFLAGS) $@.c aflnet.o -o $@ $(LDFLAGS)

aflnet-replay-simple: aflnet-replay-simple.c $(COMM_HDR) aflnet.o aflnet.h | test_x86
	$(CC) $(CFLAGS) $@.c aflnet.o -o $@ $(LDFLAGS)

afl-showmap: afl-showmap.c $(COMM_HDR) | test_x86
	$(CC) $(CFLAGS) $@.c -o $@ $(LDFLAGS)

aflnet-showmap: aflnet-showmap.c $(COMM_HDR) aflnet.o aflnet.h | test_x86
	$(CC) $(CFLAGS) $@.c aflnet.o -o $@ $(LDFLAGS)

aflnet-showmap-nwe: aflnet-showmap-nwe.c $(COMM_HDR) aflnet.o aflnet.h | test_x86
	$(CC) $(CFLAGS) $@.c aflnet.o -o $@ $(LDFLAGS)	
